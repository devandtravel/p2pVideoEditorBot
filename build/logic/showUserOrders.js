import { colorizationKeyboardActions, editPreferencesKeyboardActions, musicKeyboardActions } from '../keyboards/keyboardActions';
export const showUserOrders = (ctx) => {
    var _a;
    const userId = (_a = ctx.from) === null || _a === void 0 ? void 0 : _a.id;
    if (Object.keys(ctx.session.orders).length &&
        userId !== undefined &&
        ctx.session.orders.hasOwnProperty(userId) &&
        Object.keys(ctx.session.orders[userId].orders).length) {
        ctx.reply('Твои заказы \n' +
